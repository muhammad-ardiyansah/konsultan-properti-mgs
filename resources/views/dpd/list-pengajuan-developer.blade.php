            ...
            <div class="card ribbon-box">
                <div class="card-body">
                    ...
                    <div class="ribbon-content">   
                        <form id="cari-pengajuan" name="cari-pengajuan" method="get" action="{{ route('dpd.listPengajuan') }}">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('dpd.listPengajuan') }}" class="btn btn-warning btn-m ms-3"> Reset</a>
                            ...
                            <tbody>
                                @forelse ($pengajuanDevelopers as $key => $pengajuan) 
                                    <tr>
                                        ...
                                        <a href="{{ route('dpd.detailPengajuan', ['id' => $pengajuan->id]) }}" class="action-icon view" title="Lihat detail"> <i class="mdi mdi-eye"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
