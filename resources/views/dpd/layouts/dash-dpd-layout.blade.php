                ...
                <ul class="list-unstyled topbar-menu float-end mb-0">
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" id="topbar-userdrop" href="#" role="button" aria-haspopup="true"
                            ...
                            <span>
                                <span class="account-user-name">DPD {{ Auth::user()->name }}</span>
                ...
                <div class="leftside-menu leftside-menu-detached">
                    ...
                    <div class="leftbar-user">
                        <a href="javascript: void(0);">
                            ...
                            <span class="leftbar-user-name">DPD {{ Auth::user()->name }}</span>
                        </a>
                    </div>
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item {{ (request()->is('dpd/dashboard*')) ? 'menuitem-active' : '' }}">
                            <a href="#" class="side-nav-link {{ (request()->is('dpd/dashboard*')) ? 'active' : '' }}">
