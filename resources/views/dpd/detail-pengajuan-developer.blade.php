            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('dpd.listPengajuan') }}">List Pengajuan</a></li>
            ...
            <div class="card ribbon-box">
                <div class="card-body">
                    ...
                    <div class="ribbon-content">   
                        ...
                        <div class="row mb-3">
                            <label for="persetujuan_pengajuan_blok_rumah" class="col-lg-6 col-xl-6 col-form-label">Persetujuan Pengajuan Blok Rumah (Checklist bila Anda menyetujui nya)</label>
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-check form-checkbox-success mt-1 mb-2">
                                    <input type="checkbox" class="form-check-input" name="pilih_semua" value="">
                            ...
                            @foreach ($pengajuanDeveloperDetails as $data)
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 mb-2">
                                    ...
                                    <div class="form-check form-checkbox-success mb-2">
                                        <input type="checkbox" class="form-check-input" name="blok_rumah_chk_box" value="{{ $data->id }}" @if ($data->tlu_sts_peng_blk_rmh_id == 31) checked @endif>
                                ...
                                @csrf   
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-lg-4 col-xl-4 mb-3">
                                            ...
                                            <a href="{{ route('dpd.listPengajuan') }}" class="btn btn-warning btn-m"> Kembali</a>
                                        </div>                  
