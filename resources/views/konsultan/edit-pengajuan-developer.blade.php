            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('konsultan.listPengajuan') }}">List Pengajuan</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('konsultan.detailPengajuan', ['id' => $pengajuanDeveloper->id]) }}">Detail Pengajuan</a></li>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xs-12">
            ...
            @php
                ...
                $oldCatatanValue = old('catatan', $catatan);

            @endphp

            <form  method="POST" action="{{ route('konsultan.updatePengajuan') }}" class="form-horizontal {{ $errors->any() ? 'needs-validation was-validated' : '' }}" novalidate>
            @csrf
                                    ...
                                    <div class="col-9">    
                                        ...
                                        <option value="">[- Pilih Developer -]</option>
                                            @foreach ($developers as $id => $nama_perusahaan)
                                                <option value="{{ $id }}" {{ $id == $oldDeveloperIdValue ? "selected" : "" }}>{{ $nama_perusahaan }}</option>
                                            @endforeach
                                        </select>          
                                        @error('developer_id')
                                            <div class="invalid-feedback">
                    ...
                    <div class="card-body">
                        <div class="justify-content-end row">
                            <div class="col-9">          
                                ...
                                <a href="{{ route('konsultan.detailPengajuan', ['id' => $pengajuanDeveloper->id]) }}" class="btn btn-warning btn-m"> Kembali</a>
                            </div>
                        </div>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
