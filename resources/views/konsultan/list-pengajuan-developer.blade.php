            ...
            <div class="card ribbon-box">
                <div class="card-body">
                    ...
                    <div class="ribbon-content">   
                        <form id="cari-pengajuan" name="cari-pengajuan" method="get" action="{{ route('konsultan.listPengajuan') }}">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 text-end">
                                    ...
                                    <a href="{{ route('konsultan.listPengajuan') }}" class="btn btn-warning btn-m ms-3"> Reset</a>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12 col-md-6 text-end">
                            <a href="{{ route('konsultan.formPengajuan') }}" class="btn btn-primary btn-m ms-3"><i class="mdi mdi-plus"></i> Buat Pengajuan Baru</a>
                        </div>
                            ...
                            <tbody>
                                @forelse ($pengajuanDevelopers as $key => $pengajuan) 
                                    <tr>
                                        ...
                                        <a href="{{ route('konsultan.detailPengajuan', ['id' => $pengajuan->id]) }}" class="action-icon view" title="Lihat detail"> <i class="mdi mdi-eye"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
