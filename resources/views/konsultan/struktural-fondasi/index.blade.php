            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Template Pemeriksaan Struktural Fondasi</li>
                    </ol>
                </div>
                <h4 class="page-title">Template Komponen Pemeriksaan Elemen Struktural Fondasi </h4>
            </div>
        </div>
    </div>     
    <!-- end page title --> 
    ...
    $(function () {
        ...
        $(document).on('change', "#master_template_id", function(event) {    
            ...
            if ($(this).val()) {
                ...
                $.ajax({
                    url: "{{ route('konsultan.getDataTemplateStrukturalFondasi') }}",
                    method: 'GET',
        ...
        $(document).on('change', "#jenis_input_pengukuran_1", function(event) {    
            ...
            if ($(this).val() !== "0") {
                ...
                var url = '{{ route('konsultan.getKelInpAngPeng1StrukturalFondasi') }}'; 
                if ($(this).val() == "2") {
                    url = '{{ route('konsultan.getKelInpTextPeng1StrukturalFondasi') }}';
                }    

                if ($(this).val() == "3") {
                    url = '{{ route('konsultan.getKelInpChkboxPeng1StrukturalFondasi') }}';
                }

                if ($(this).val() == "4") {
                    url = '{{ route('konsultan.getKelInpSlcboxPeng1StrukturalFondasi') }}';
                }
        ...
        $(document).on('change', "#jenis_input_pengukuran_2", function(event) {    
            ...
            if ($(this).val() !== "0") {
                ...
                var url = '{{ route('konsultan.getKelInpAngPeng2StrukturalFondasi') }}'; 
                if ($(this).val() == "2") {
                    url = '{{ route('konsultan.getKelInpTextPeng2StrukturalFondasi') }}';
                }    

                if ($(this).val() == "3") {
                    url = '{{ route('konsultan.getKelInpChkboxPeng2StrukturalFondasi') }}';
                }

                if ($(this).val() == "4") {
                    url = '{{ route('konsultan.getKelInpSlcboxPeng2StrukturalFondasi') }}';
                }
        ...
        $(document).on('change', "#jenis_input_pengukuran_3", function(event) {    
            ...
            if ($(this).val() !== "0") {
                ...
                var url = '{{ route('konsultan.getKelInpAngPeng3StrukturalFondasi') }}'; 
                if ($(this).val() == "2") {
                    url = '{{ route('konsultan.getKelInpTextPeng3StrukturalFondasi') }}';
                }    

                if ($(this).val() == "3") {
                    url = '{{ route('konsultan.getKelInpChkboxPeng3StrukturalFondasi') }}';
                }

                if ($(this).val() == "4") {
                    url = '{{ route('konsultan.getKelInpSlcboxPeng3StrukturalFondasi') }}';
                }
        ...
        $(document).on('change', "#jenis_input_pengukuran_4", function(event) {    
            // alert($(this).val());
            $("#kelompok-input-angka-pengukuran-4-content").empty();

            if ($(this).val() !== "0") {
                
                var url = '{{ route('konsultan.getKelInpAngPeng4StrukturalFondasi') }}'; 
                if ($(this).val() == "2") {
                    url = '{{ route('konsultan.getKelInpTextPeng4StrukturalFondasi') }}';
                }    

                if ($(this).val() == "3") {
                    url = '{{ route('konsultan.getKelInpChkboxPeng4StrukturalFondasi') }}';
                }

                if ($(this).val() == "4") {
                    url = '{{ route('konsultan.getKelInpSlcboxPeng4StrukturalFondasi') }}';
                }
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        // alert(response);
                        $("#kelompok-input-angka-pengukuran-4-content").html(response);                    
                    },
                    error: function(response) {
                        console.log(response);   
                    }
