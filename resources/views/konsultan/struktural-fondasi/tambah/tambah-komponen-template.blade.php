                ...
                <div class="card-body">
                    ...
                    <div class="ribbon-content">    
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="label_1" name="label_1" placeholder="" value="{{ old('label_1') }}" >
                                @error('label_1')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
                        ...
                        <div id="kelompok-input-angka-pengukuran-1-content">
                            ...
                            @if (old('jenis_input_pengukuran_1')==1)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-angka-pengukuran-1')
                            @endif

                            @if (old('jenis_input_pengukuran_1')==2)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-text-pengukuran-1')
                            @endif

                            @if (old('jenis_input_pengukuran_1')==3 || old('jenis_input_pengukuran_1')==4)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-checkbox-pengukuran-1')
                            @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="label_2" name="label_2" placeholder="" value="{{ old('label_2') }}" >
                                @error('label_2')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
                        ...
                        <div id="kelompok-input-angka-pengukuran-2-content">
                            ...
                            @if (old('jenis_input_pengukuran_2')==1)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-angka-pengukuran-2')
                            @endif

                            @if (old('jenis_input_pengukuran_2')==2)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-text-pengukuran-2')
                            @endif

                            @if (old('jenis_input_pengukuran_2')==3 || old('jenis_input_pengukuran_2')==4)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-checkbox-pengukuran-2')
                            @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="label_3" name="label_3" placeholder="" value="{{ old('label_3') }}" >
                                @error('label_3')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
                        ...
                        <div id="kelompok-input-angka-pengukuran-3-content">
                            ...
                            @if (old('jenis_input_pengukuran_3')==1)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-angka-pengukuran-3')
                            @endif

                            @if (old('jenis_input_pengukuran_3')==2)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-text-pengukuran-3')
                            @endif

                            @if (old('jenis_input_pengukuran_3')==3 || old('jenis_input_pengukuran_3')==4)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-checkbox-pengukuran-3')
                            @endif
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-5">
                                <input type="text" class="form-control" id="label_4" name="label_4" placeholder="" value="{{ old('label_4') }}" >
                                @error('label_4')
                                    <div class="invalid-feedback">
                                    {{ $message }}
                                    </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-5">    
                                <select class="form-control select2" name="jenis_input_pengukuran_4" id="jenis_input_pengukuran_4" data-toggle="select2" @error('jenis_input_pengukuran_4') required @enderror >
                                    @foreach ($tluJenisInputPengukurans as $id => $jenis_input)
                                        <option value="{{ $id }}" {{ $id == old('jenis_input_pengukuran_4') ? "selected" : "" }}>{{ $jenis_input }}</option>
                                    @endforeach
                                </select>          
                        ...
                        <div id="kelompok-input-angka-pengukuran-4-content">
                            ...
                            @if (old('jenis_input_pengukuran_4')==1)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-angka-pengukuran-4')
                            @endif

                            @if (old('jenis_input_pengukuran_4')==2)
                                @include('konsultan.struktural-fondasi.tambah.kelompok-input-text-pengukuran-4')
                            @endif

                            @if (old('jenis_input_pengukuran_4')==3 || old('jenis_input_pengukuran_3')==4)
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <textarea class="form-control" placeholder="" id="print_on_template" name="print_on_template" rows="10" @error('print_on_template') required @enderror >{{ old('print_on_template') }}</textarea>                                    
