                ...
                <div class="card-body">
                    ...
                    <div class="ribbon-content">
                        ...
                        @php
                            ...
                            $oldDeveloperIdValue = old('developer_id', $user->developers()->first()->id);
                            $msgErrDeveloperId = "";
                            ...
                            $oldNameValue = old('name', $user->name);
                            $msgErrName = "";
                            ...
                            $oldUsernameValue = old('username', $user->username);
                            $msgErrUsername = "";
                            ...
                            $oldEmailValue = old('email', $user->email);
                            $msgErrEmail = "";
                        ...
                        <form  method="POST" action="{{ route('konsultan.updateRegistrasiUserDeveloper') }}" class="form-horizontal {{ $errors->any() ? 'needs-validation was-validated' : '' }}" novalidate>
                        @csrf 
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6 col-xl-6">
                                    <input type="text" class="form-control" id="password" name="password" placeholder="" @error('password') required @enderror value="{{ old('password') }}">
                                    @error('password')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6 col-xl-6">
                                    <input type="text" class="form-control" id="password_confirmation" name="password_confirmation" placeholder="" @error('password_confirmation') required @enderror value="{{ old('password_confirmation') }}">
