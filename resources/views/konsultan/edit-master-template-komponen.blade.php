...
<div class="content">
    ...
    <div class="row">
        <div class="col-12">
            ...
            $oldNamaMasterValue = old('nama_master', $tluMasterTemplate->nama_master);
            $msgErrNamaMaster = "";
            ...
            @csrf            
                <div class="card ribbon-box">
                    <div class="card-body">
                        <div class="ribbon ribbon-info float-start"><i class="mdi mdi-access-point me-1"></i>Edit</div>
                        ...
                        <div class="ribbon-content">   
                                ...
                                <div class="col-6">    
                                    ...
                                    <option value="">[- Pilih Propinsi Apersi -]</option>
                                        @foreach ($provinces as $code => $name)
                                            <option value="{{ $code }}" {{ $code == old('province_code', $tluMasterTemplate->province_code) ? "selected" : "" }}>{{ $name }}</option>
                                        @endforeach
                                    </select>          
                                    @error('province_code')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <div class="form-check form-checkbox-success mb-2">
                                        {{-- <input type="hidden" name="aktif" value="{{ old('aktif') }}"> --}}
                                        <input type="checkbox" class="form-check-input" id="aktif" name="aktif" value=1 {{ old('aktif', $tluMasterTemplate->aktif)!=null ? 'checked' : ''  }} >
                                        <label class="form-check-label" for="aktif">Aktif {{ old('aktif', $tluMasterTemplate->aktif) }}</label>
                                    </div>
                                </div>    
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 text-end">
                                    <input name="id" type="hidden" value="{{ $tluMasterTemplate->id; }}">                        
