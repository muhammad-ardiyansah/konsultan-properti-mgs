...
<tr>
    ...
    <td>
        {{ $subtemplatekomponen->no_komponen.' '.$subtemplatekomponen->nama_komponen }}
    </td>
    <td class="font-12"> 
        @if ($subtemplatekomponen->parent_id && $subtemplatekomponen->jenis_input_pengukuran_1 == 0 && $subtemplatekomponen->jenis_input_pengukuran_2 == 0 && $subtemplatekomponen->jenis_input_pengukuran_3 == 0)
            -
        @else
