                                    ...
                                    <ul class="navbar-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="topnav-pengaturan">
                                                <a href="index.html" class="dropdown-item">User</a>
                                                <div class="dropdown">
                                                    <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-template-simak" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        Template SIMAK <div class="arrow-down"></div>
                                                    </a>
                                                    <div class="dropdown-menu" aria-labelledby="topnav-template-simak">
                                                        <a href="{{ route('konsultan.masterTemplateKomponenPemeriksaan') }}" class="dropdown-item">Master Template</a>
                                                        <a href="{{ route('konsultan.templateStrukturalFondasi') }}" class="dropdown-item">Template Pemeriksaan Struktural Fondasi</a>
                                                        <a href="{{ route('konsultan.templateKomponenPemeriksaan') }}" class="dropdown-item">Template Pemeriksaan Kelaikan Fungsi Bangunan</a>
                                                    </div>
                                                </div>                                            
                                            </div>
                                        </li>
