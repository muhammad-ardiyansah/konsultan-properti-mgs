...
<div class="content">
    ...
    <div class="row">
        ...
        @endif
            ...
            <div class="card ribbon-box">
                <div class="card-body">
                    ...
                    <div class="ribbon-content">   
                        ...
                        <div class="row mb-3">
                            <label for="persetujuan_pengajuan_blok_rumah" class="col-lg-6 col-xl-6 col-form-label">Persetujuan Pengajuan Blok Rumah (<a href="{{ route('konsultan.laporanPengajuan', ['id' => $pengajuanDeveloper->id]) }}" target="_blank">Laporan</a>) @if ($denganApersi) (Checklist bila DPD menyetujuinya) @endif</label>
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-check form-checkbox-success mt-1 mb-2">
                                    <input type="checkbox" class="form-check-input" name="pilih_semua" value="" @if ((!$isExistsStatus31 && $denganApersi) || (!$isExistsStatus64 && !$denganApersi)) disabled @endif>
                            ...
                            @foreach ($pengajuanDeveloperDetails as $data)
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 mb-2">
                                    ...
                                    <div class="form-check form-checkbox-success mb-2">
                                        <input type="checkbox" class="form-check-input" name="blok_rumah_chk_box" value="{{ $data->id }}" @if (($data->tlu_sts_peng_blk_rmh_id == 31) || ($data->tlu_sts_peng_blk_rmh_id == 71)) checked @endif  @if ((!$isExistsStatus31 && $denganApersi) || (!$isExistsStatus64 && !$denganApersi)) disabled @endif >
                                        <label class="form-check-label" for="customCheckcolor2">{{ $data->blok_rumah }}</label>
                                    </div>
                                ...
                                @csrf   
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-lg-4 col-xl-4 mb-3">
                                            ...
                                            <a href="{{ route('konsultan.listPengajuan') }}" class="btn btn-warning btn-m"> Kembali</a>
                                        </div>
            ...
            <div class="card ribbon-box">
                <div class="card-body">
                    <div class="ribbon ribbon-primary float-start"><i class="mdi mdi-access-point me-1"></i>Ijin Edit Developer</div>
                    <h5 class="text-primary float-end mt-0"><i class="uil-file-alt"></i></h5>
                    <div class="ribbon-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-xl-12">                        
                                <form id="ijin-edit-developer" name="ijin-edit-developer" method="post" action="{{ route('konsultan.setIjinEditPengajuan') }}">
                                @csrf                                   
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        ...
                                        <div class="col-lg-4 col-xl-4 mb-3">
                                            <input name="id" type="hidden" value="{{ $pengajuanDeveloper->id; }}">
                                            <input name="ijin_edit" type="hidden" value="{{ $pengajuanDeveloper->ijin_edit ? 0 : 1 }}">
                                            <button type="Submit" class="btn btn-primary"><i class="mdi mdi-book-edit-outline"></i> {{ $pengajuanDeveloper->ijin_edit ? 'Cabut ijin edit untuk developer' : 'Beri ijin edit untuk developer'  }}</button>
                                        </div>                  
