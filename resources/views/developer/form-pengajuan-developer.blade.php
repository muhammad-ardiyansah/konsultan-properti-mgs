...
<div class="content">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xs-12">
            ...
            <form  method="POST" action="{{ route('developer.simpanPengajuan') }}" class="form-horizontal {{ $errors->any() ? 'needs-validation was-validated' : '' }}" novalidate>
            @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="ribbon-content">
                                ...
                                <div class="alert alert-success" role="alert">
                                    <i class="dripicons-checkmark me-2"></i> {{ Session::get('success') }} Lihat list pengajuan Anda <a href="{{ route('developer.listPengajuan') }}">disini</a> 
                                </div>
                                @endif
