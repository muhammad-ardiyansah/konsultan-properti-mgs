            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('developer.listPengajuan') }}">List Pengajuan</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('developer.detailPengajuan', ['id' => $pengajuanDeveloper->id]) }}">Detail Pengajuan</a></li>
                        <li class="breadcrumb-item active">Edit Pengajuan</li>
                    </ol>
                </div>
                <h4 class="page-title">Edit Pengajuan</h4>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-10 col-xs-12">
            ...
            @php
                ...
                $oldLuasTanahValue = old('luas_tanah', $pengajuanDeveloper->luas_tanah);
                $msgAddErrLuasTanah = "";
                ...
                $oldKetinggianBangunanValue = old('ketinggian_bangunan', $pengajuanDeveloper->ketinggian_bangunan);
                ...
                $oldJumlahLantaiValue = old('jumlah_lantai', $pengajuanDeveloper->jumlah_lantai);
                ...
                $oldLuasLantaiValue = old('luas_lantai', $pengajuanDeveloper->luas_lantai);
                $msgAddErrLuasLantai = "";
                ...
                $oldBlokRumahValue = old('blok_rumah', $pengajuanDeveloper->blok_rumah);
                $msgErrBlokRumah = "";
                ...
                $oldHargaJualPerUnitValue = old('harga_jual_per_unit', $pengajuanDeveloper->harga_jual_per_unit);
                ...
                $oldTluTipeRumahIdValue = old('tlu_tipe_rumah_id', $pengajuanDeveloper->tlu_tipe_rumah_id);
                $oldPosisiKoordinatValue = old('posisi_koordinat', $pengajuanDeveloper->posisi_koordinat);
                $oldKlasifikasiKompleksitasValue = old('klasifikasi_kompleksitas', $pengajuanDeveloper->klasifikasi_kompleksitas);
                $oldDeveloperIdValue = old('developer_id', $pengajuanDeveloper->developer_id);
                $oldPerumahanDeveloperIdValue = old('perumahan_developer_id', $pengajuanDeveloper->perumahan_developer_id);
                $oldRumahSampleValue = old('rumah_sample', $pengajuanDeveloper->rumah_sample);
                $oldProvinceCodeApersiValue = old('province_code_apersi', $pengajuanDeveloper->province_code_apersi);
                $oldSertifikatHakAtasTanahValue = old('sertifikat_hak_atas_tanah', $pengajuanDeveloper->sertifikat_hak_atas_tanah);
                $oldIzinPemanfaatanTanahValue = old('izin_pemanfaatan_tanah', $pengajuanDeveloper->izin_pemanfaatan_tanah);
                $oldPengesahanSitePlanValue = old('pengesahan_site_plan', $pengajuanDeveloper->pengesahan_site_plan);
                $oldNomorImbValue = old('nomor_imb', $pengajuanDeveloper->nomor_imb);
                $oldJenisNomorIzinLainnyaValue = old('jenis_nomor_izin_lainnya', $pengajuanDeveloper->jenis_nomor_izin_lainnya);
                $oldNomorIzinlainnyaValue = old('nomor_izin_lainnya', $pengajuanDeveloper->nomor_izin_lainnya);
                $oldBlokRumahAddedValue = old('blok_rumah_added', '{}');
                $oldBlokRumahDeletedValue = old('blok_rumah_deleted', '{}');
                $oldPengawasIdValue = old('pengawas_id', $pengajuanDeveloper->pengawas_id);
                $oldPenanggungJawabPengawasValue = $pengajuanDeveloper->pengawas->nama_direktur;
                $oldCatatanValue = old('catatan');

            @endphp

            <form  method="POST" action="{{ route('developer.updatePengajuan') }}" class="form-horizontal {{ $errors->any() ? 'needs-validation was-validated' : '' }}" novalidate>
            @csrf
                <div class="card ribbon-box">
                    <div class="card-body">
                        <div class="ribbon ribbon-primary float-start"><i class="mdi mdi-access-point me-1"></i> Edit Data Perumahan</div>
                        ...
                        <div class="ribbon-content">
                                ...
                                <div class="row mb-3">
                                    <label for="fungsi_bangunan" class="col-3 col-form-label">Kode Pengajuan</label>
                                    <div class="col-9">
                                        <input type="hidden" name="kode_pengajuan" value="{{ $pengajuanDeveloper->kode_pengajuan }}">
                                        <input type="text" class="form-control" id="kode_pengajuan" name="kode_pengajuan" placeholder=""  value="{{ $pengajuanDeveloper->kode_pengajuan }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="hidden" name="tlu_fungsi_bangunan_id" value="{{ $pengajuanDeveloper->tlu_fungsi_bangunan_id }}">
                                        <input type="text" class="form-control" id="fungsi_bangunan" name="fungsi_bangunan" placeholder=""  value="{{ $pengajuanDeveloper->tlu_fungsi_bangunan->fungsi_bangunan }}" readonly>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-9">    
                                        <select class="form-control select2" name="tlu_tipe_rumah_id" id="tlu_tipe_rumah_id" data-toggle="select2" @error('tlu_tipe_rumah_id') required @enderror >
                                            ...
                                            @foreach ($tluTipeRumah as $id => $tipe_rumah)
                                                <option value="{{ $id }}" {{ $id == $oldTluTipeRumahIdValue ? "selected" : "" }}>{{ $tipe_rumah }}</option>
                                            @endforeach
                                        </select>          
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="posisi_koordinat" name="posisi_koordinat" placeholder="" @error('posisi_koordinat') required @enderror value="{{ $oldPosisiKoordinatValue }}" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" class="form-control" id="klasifikasi_kompleksitas" name="klasifikasi_kompleksitas" placeholder="" @error('klasifikasi_kompleksitas') required @enderror value="{{ $oldKlasifikasiKompleksitasValue }}" >
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-9">    
                                        ...
                                        @foreach ($perumahanDevelopers as $id => $nama_perumahan)
                                            <option value="{{ $id }}" {{ $id == $oldPerumahanDeveloperIdValue ? "selected" : "" }}>{{ $nama_perumahan }}</option>
                                        @endforeach                                        
                                        </select>          
                                ...
                                @php
                                    $oldBlokRumahs = [];
                                    if (!empty($oldBlokRumahValue)) {
                                        $oldBlokRumahs = explode(",", $oldBlokRumahValue);
                                    }
                                        ...
                                        <option value="">[- Pilih 1 rumah yang mewakili semua blok rumah -]</option>
                                            @if (!$msgErrBlokRumah)
                                                @forelse ($oldBlokRumahs as $oldBlokRumah)
                                                    <option value="{{ $oldBlokRumah }}" {{ $oldBlokRumah == $oldRumahSampleValue ? "selected" : "" }}>{{ $oldBlokRumah }}</option>
                                                @endforeach
                                            @endif    
                                        </select>          
                                        @error('rumah_sample')
                        ...
                        <div class="ribbon-content">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">    
                                    ...
                                    @foreach ($pengawas as $id => $nama_perusahaan)
                                        <option value="{{ $id }}" {{ $id == $oldPengawasIdValue ? "selected" : "" }}>{{ $nama_perusahaan }}</option>
                                    @endforeach                                        
                                    </select>          
                                    @error('pengawas_id')
                                        <div class="invalid-feedback">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" id="penanggung_jawab_pengawas" name="penanggung_jawab_pengawas" disabled value="{{ $oldPenanggungJawabPengawasValue }}">
                                </div>
                            </div>                            
                                ...
                                <div class="col-9">    
                                    ...
                                    <option value="">[- Pilih Provinsi -]</option>
                                        @foreach ($provinces as $code => $name)
                                            <option value="{{ $code }}" {{ $code == $oldProvinceCodeApersiValue ? "selected" : "" }}>{{ $name }}</option>
                                        @endforeach
                                    </select>          
                ...
                <div class="card ribbon-box">
                    <div class="card-body">
                        <div class="ribbon ribbon-primary float-start"><i class="mdi mdi-access-point me-1"></i> Edit Data Administrasi</div>
                        <h5 class="text-primary float-end mt-0"><i class="uil-file-plus-alt"></i></h5>
                        <div class="ribbon-content">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="sertifikat_hak_atas_tanah" name="sertifikat_hak_atas_tanah" placeholder="" @error('sertifikat_hak_atas_tanah') required @enderror value="{{ $oldSertifikatHakAtasTanahValue }}" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="izin_pemanfaatan_tanah" name="izin_pemanfaatan_tanah" placeholder="" @error('izin_pemanfaatan_tanah') required @enderror value="{{ $oldIzinPemanfaatanTanahValue }}" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="pengesahan_site_plan" name="pengesahan_site_plan" placeholder="" @error('pengesahan_site_plan') required @enderror value="{{ $oldPengesahanSitePlanValue }}" >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" id="nomor_imb" name="nomor_imb" placeholder="" @error('nomor_imb') required @enderror value="{{ $oldNomorImbValue }}" >
                                    @error('nomor_imb')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-4">
                                    <input type="text" class="form-control" id="jenis_nomor_izin_lainnya" name="jenis_nomor_izin_lainnya" placeholder="Jenis nomor izin lainnya" value="{{  $oldJenisNomorIzinLainnyaValue }}" >
                                </div>
                                <div class="col-5">
                                    <input type="text" class="form-control" id="nomor_izin_lainnya" name="nomor_izin_lainnya" placeholder="Nomor izin lainnya" value="{{ $oldNomorIzinlainnyaValue }}" >
                                </div>
                            </div>
                ...
                <div class="card ribbon-box">
                    <div class="card-body">
                        <div class="ribbon ribbon-primary float-start"><i class="mdi mdi-access-point me-1"></i> Catatan</div>
                        <h5 class="text-primary float-end mt-0"><i class="uil-file-plus-alt"></i></h5>
                        <div class="ribbon-content">

                            <div class="row mb-3">
                                <div class="col-12">    
                                    <textarea class="form-control" placeholder="" id="catatan" name="catatan" rows="10">{{ $oldCatatanValue }}</textarea>
                                </div>                      
                            </div>
                ...
                <div class="card widget-flat">
                    <div class="card-body">
                        <div class="justify-content-end row">
                            <div class="col-9">          
                                <input id="id" name="id" type="hidden" value="{{ $pengajuanDeveloper->id; }}">
                                <input id="developer_id" name="developer_id" type="hidden" value="{{ $pengajuanDeveloper->developer_id; }}">              
                                <input id="blok_rumah_ori" name="blok_rumah_ori" type="hidden" value="{{ $blokRumahOri }}">
                                <input id="blok_rumah_added" name="blok_rumah_added" type="hidden" value="{{ $oldBlokRumahAddedValue }}">
                                <input id="blok_rumah_deleted" name="blok_rumah_deleted" type="hidden" value="{{ $oldBlokRumahDeletedValue }}">
                                <button type="Submit" class="btn btn-primary">Simpan</button>
                                <a href="{{ route('developer.detailPengajuan', ['id' => $pengajuanDeveloper->id]) }}" class="btn btn-warning btn-m"> Kembali</a>
                            </div>
                        </div>
                    </div> <!-- end card-body-->
                </div> <!-- end card-->
...
window.addEventListener('DOMContentLoaded', function() {
    $(function () {
        ...
        $("#blok_rumah").on('itemAdded', function(event) {
            ...
            var blokRumahDeleted = JSON.parse($('#blok_rumah_deleted').val());
            var blokRumahAdded = JSON.parse($('#blok_rumah_added').val());
            if (blokRumahDeleted[event.item]) {
                // alert('key Exists');
                delete blokRumahDeleted[event.item];
            }else{
                blokRumahAdded[event.item] = $('#id').val();
            }
            $('#blok_rumah_added').val(JSON.stringify(blokRumahAdded));
            $('#blok_rumah_deleted').val(JSON.stringify(blokRumahDeleted));        
            console.log('blokRumahAdded');
            console.log(blokRumahAdded);
            console.log('blokRumahDeleted');
            console.log(blokRumahDeleted);        
        ...
        $("#blok_rumah").on('itemRemoved', function(event) {
            ...
            var blokRumahAdded = JSON.parse($('#blok_rumah_added').val());
            var blokRumahDeleted = JSON.parse($('#blok_rumah_deleted').val());
            if (blokRumahAdded[event.item]) {
                // alert('key Exists');
                delete blokRumahAdded[event.item];
            }else{
                blokRumahDeleted[event.item] = $('#id').val();
            }
            $('#blok_rumah_deleted').val(JSON.stringify(blokRumahDeleted));     
            $('#blok_rumah_added').val(JSON.stringify(blokRumahAdded));   
            console.log('blokRumahDeleted');
        ...
        $(document).on('change', "#perumahan_developer_id", function(event) {            
            ...
            $.ajax({
                url: "{{ route('developer.getPerumahanDeveloperAdditionalInfo', ['id' =>" + $(this).val() + "]) }}",
                method: 'GET',
                headers: headers,
                data: {id: $(this).val()},
                success: function (response) {
