                            ...
                            @foreach ($pengajuanDeveloperDetails as $data)
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 mb-2">
                                    ...
                                    <div class="form-check form-checkbox-success mb-2">
                                        <input type="checkbox" class="form-check-input" name="blok_rumah_chk_box" value="{{ $data->id }}" @if (($data->tlu_sts_peng_blk_rmh_id == 31) || ($data->tlu_sts_peng_blk_rmh_id == 71))  checked @endif disabled>
                ...
                <div class="card-body">
                    ...
                    <div class="ribbon-content">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                <input type="text" class="form-control" id="dpd_apersi" name="dpd_apersi" disabled value="{{ $pengajuanDeveloper->tlu_status_pengajuan_developer->nama_status }} ({{ $pengajuanDeveloper->tlu_status_pengajuan_developer->keterangan }})">
                            </div>
                        </div>                        
