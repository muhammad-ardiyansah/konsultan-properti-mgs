...
window.addEventListener('DOMContentLoaded', function() {
    $(function () {
        ...
        $(document).on('change', "#developer_id", function(event) {
        ...
        // $('#tambah-perumahan-developer').on('click', function () {    
            ...
            $.ajax({
                ...
                method: 'GET',
                headers: headers,
                data: {developer_id: {{ $developer->id }}, url_tambah: 'developer.tambahPerumahanDeveloper', url_list: 'developer.listPerumahanDeveloper'},
                success: function (response) {
        ...
        // $('.edit').on('click', function () {    
            ...
            $.ajax({
                ...
                method: 'GET',
                headers: headers,
                data: {id: id, url_edit: 'developer.editPerumahanDeveloper', url_list: 'developer.listPerumahanDeveloper'},
                success: function (response) {
                    $("#staticBackdrop").modal("show");
                    $('.modal-title').html(title);
                    $("#modal-content").empty();
        ...
        $(document).on('click', "#confirm-yes", function(event) {
            ...
            $.ajax({
                ...
                method: 'POST',
                headers: headers,
                data: {id: $('#confirm-value').val(), url_list: 'developer.listPerumahanDeveloper', is_ajax: 1},
                success: function (response) {
                    $("#ajax-update").empty();
                    $("#ajax-update").html(response);                    
