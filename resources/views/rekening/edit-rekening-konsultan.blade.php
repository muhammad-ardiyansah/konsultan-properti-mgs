    ...
    <div class="row">
        <div class="col-12">
            ...
            @php
                ...
                $oldTluBankIdValue = old('tlu_bank_id', $tluNoRekening->tlu_bank_id);
                $msgErrTluBankId = "";
                ...
                $oldNoRekeningValue = old('no_rekening', $tluNoRekening->no_rekening);
                $msgErrNoRekening = "";
                ...
                $oldNamaPemilikRekeningValue = old('nama_pemilik_rekening', $tluNoRekening->nama_pemilik_rekening);
                        ...
                        <div class="ribbon-content">   
                            ...
                            <div class="row mb-3">
                                <div class="col-12 text-end">     
                                    <input name="id" type="hidden" value="{{ $tluNoRekening->id; }}">                                                      
