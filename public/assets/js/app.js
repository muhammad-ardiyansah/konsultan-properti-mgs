...
!(function ($) {
        ...
        (LeftSidebar.prototype.initMenu = function () {
            ...
            $(document).on("click", ".button-menu-mobile", function (e) {
                ...
                if (self.window.width() >= 576) {
                    if (
                        self.body.attr("data-leftbar-compact-mode") ===
                        "condensed"
                    ) {
    ...
    (function ($) {
        ...
        (Topbar.prototype.initMenu = function () {
            ...
            (Topbar.prototype.initSearch = function () {
                // Serach Toggle
                var navDropdowns = $(
                    ".navbar-custom .dropdown:not(.app-search)"
                );
        ...
        (RightBar.prototype._selectOptionsFromConfig = function () {
            ...
            if (config) {
                ...
                if (!config.isDarkModeEnabled) {
                    ...
                    if (config.layout === "vertical")
                        $("input[type=checkbox][name=theme]").prop(
                            "disabled",
                            false
                        );
                }
            ...
            (RightBar.prototype.init = function () {
                ...
                $(document).on("click", "body", function (e) {
                    if (
                        $(e.target).closest(".end-bar-toggle, .end-bar")
                            .length > 0
                    ) {
                        return;
                    }
                    ...
                    if (
                        $(e.target).closest(".leftside-menu, .side-nav")
                            .length > 0 ||
    ...
    (function ($) {
        ...
        (LayoutThemeApp.prototype._saveConfig = function (newConfig) {
            ...
            (LayoutThemeApp.prototype._getStoredConfig = function () {
                ...
                if (bodyConfig) {
                    ...
                    config["isScrollable"] =
                        bodyConfig["leftSidebarScrollable"];
        ...
        (LayoutThemeApp.prototype.activateScrollableSidebar = function () {
             ...
             */
            (LayoutThemeApp.prototype.deactivateScrollableSidebar =
                function () {
             ...
             * Activates the default theme
             */
            (LayoutThemeApp.prototype.activateDefaultSidebarTheme =
                function () {
        ...
        (LayoutThemeApp.prototype.clearSavedConfig = function () {
            ...
            (LayoutThemeApp.prototype.reset = function (callback) {
                ...
                if ($("#main-style-container").length) {
                    self.defaultSelectedStyle = $("#main-style-container").attr(
                        "href"
                    );
                }
                self.deactivateCondensedSidebar();
